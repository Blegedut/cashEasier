@foreach ($category as $ct)
    @foreach ($ct->products as $pd)
        {{-- MODAL EDIT --}}
        <div class="modal fade modal-borderless" id="modalEdit{{ $pd->id }}" tabindex="-1"
            ...
            <div class="modal-lg modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ url('product/update/' . $pd->id) }}" method="POST"
                            ...
                            <div class="form-body">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-8 mb-3 form-group">
                                        <input type="text" class="form-control" value="{{ $pd->name }}"
                                    ...
                                    <div class="col-md-8 mb-3 form-group">
                                        <input type="number" class="form-control" value="{{ $pd->stock }}"
                                    ...
                                    <div class="col-md-8 mb-3 form-group">
                                        <input type="text" class="form-control" value="{{ $pd->price }}"
